        ...
        <div className="mt-8 flex flex-col gap-8 lg:flex-row">
          <div className="flex-1 space-y-6">
            <div>
              ...
              <h2 className="mt-2 text-[24px] font-semibold tracking-tight text-[#0a1628]">Review Your Booking</h2>
            </div>
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 backdrop-blur-xl">
              ...
              <div className="mt-4 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[14px] font-semibold tracking-tight text-[#0a1628]">{jet.name}</p>
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 backdrop-blur-xl">
              ...
              <div className="mt-4 space-y-0">
                {passengers.map((p, i) => (
                  ...
                  >
                    <div>
                      <p className="text-[13px] font-medium text-[#0a1628]">{p.firstName} {p.lastName}</p>
            ...
            <div className="flex justify-between">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full bg-[#0d1f3c] px-8 py-3 text-[13px] font-medium text-white transition-colors hover:bg-[#1a3461] active:scale-[0.98]"
              >
