  ...
  return (
    <div className="mx-auto w-full max-w-5xl p-6">
      <div className="mb-2 flex items-center gap-2">
        ...
        <p className="font-mono text-[11px] uppercase tracking-widest text-neutral-600">Track My Jets</p>
      ...
      <h1 className="mt-2 text-[28px] font-semibold tracking-tight text-neutral-950">Your Active Charters</h1>
        ...
        {jets.map((jet) => (
          <div key={jet.id}>
            <div className="mb-3 flex items-center justify-between">
              <div>
                <h2 className="text-[16px] font-semibold tracking-tight text-neutral-950">{jet.name}</h2>
              ...
              <Link
                href={`/jets/${jet.id}`}
                className="inline-flex items-center gap-1 text-[12px] font-medium text-neutral-700 transition-colors hover:text-neutral-950"
              >
      ...
      {jets.length === 0 && (
        <div className="mt-12 flex flex-col items-center justify-center rounded-2xl border border-neutral-200 bg-white py-20 text-center backdrop-blur-xl">
          <Plane className="mb-4 h-12 w-12 text-neutral-300" strokeWidth={1.25} />
          <h3 className="text-[18px] font-semibold tracking-tight text-neutral-950">No active charters</h3>
