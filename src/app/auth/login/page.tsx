    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-4 py-12 text-white">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="font-mono text-[11px] uppercase tracking-widest text-white/60">Sign In</p>
          <h1 className="mt-3 text-[28px] font-semibold tracking-tight text-white">Welcome back</h1>
          <p className="mt-1 text-[13px] text-white/60">Sign in to manage your bookings</p>
        </div>
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-8 backdrop-blur-xl">
          ...
          <div className="mb-6 grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/[0.03] px-4 py-2.5 text-[12px] font-medium text-white transition-colors hover:border-white/30 hover:bg-white/[0.06]">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-black px-3 font-mono text-[10px] uppercase tracking-widest text-white/40">or continue with email</span>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="mb-1.5 block font-mono text-[10px] uppercase tracking-widest text-white/60">Email address</label>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-lg border border-white/10 bg-white/[0.03] py-3 pl-10 pr-4 text-[13px] text-white placeholder:text-white/30 outline-none focus:border-white/40"
                />
              </div>
            </div>
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label className="block font-mono text-[10px] uppercase tracking-widest text-white/60">Password</label>
                <Link href="#" className="text-[11px] text-white/60 transition-colors hover:text-white">Forgot password?</Link>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full rounded-lg border border-white/10 bg-white/[0.03] py-3 pl-10 pr-10 text-[13px] text-white placeholder:text-white/30 outline-none focus:border-white/40"
                />
                <button
                  type="button"
          ...
          <p className="mt-6 text-center text-[13px] text-white/60">
            ...
            <Link href="/auth/register" className="font-medium text-white underline-offset-4 hover:underline">
              Sign up
            </Link>
          </p>
        </div>
