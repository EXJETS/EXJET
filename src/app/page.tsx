...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-5 pb-14 sm:px-8 lg:pb-20">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-4xl">
            ...
            <motion.p variants={fadeUp} className="mt-7 max-w-xl text-[15px] leading-[1.9] text-white/60">
              ...
              publishing measured performance data for every project.
            </motion.p>
          ...
          >
            {[
              ...
              <div key={s.l} className="border border-white/[0.12] bg-white/[0.06] px-6 py-5 backdrop-blur-sm">
                <div className="font-serif text-[28px] leading-none text-white">{s.n}</div>
          ...
          <Reveal>
            {services.map((svc, i) => (
              <motion.div key={svc.label} variants={fadeUp} className="group border-t border-black/[0.07]">
                <Link href={svc.href} className="grid items-stretch lg:grid-cols-[1fr_400px]">
                  <div className="flex flex-col justify-between py-10 lg:pr-12">
                    <div>
                      <div className="mb-5 flex items-center gap-4">
                        <span className="font-mono text-[11px] text-[#dddddd]">{String(i + 1).padStart(2, "0")}</span>
                        <span className="font-mono text-[11px] uppercase tracking-[0.24em] text-[var(--color-gold)]">{svc.label}</span>
                      </div>
                      <h3 className="font-serif text-[28px] leading-[1.15] text-[#111111] lg:text-[34px]">{svc.headline}</h3>
                  ...
                  <div className="relative hidden overflow-hidden bg-[#e8e5e0] lg:block" style={{ minHeight: "280px" }}>
                    <img
                      src={svc.img}
                      alt={svc.label}
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <Reveal className="grid items-center gap-14 lg:grid-cols-2">
            <motion.div variants={fadeUp}>
              ...
              <div className="mt-2 font-serif leading-none text-white/40" style={{ fontSize: "clamp(2rem, 5vw, 4rem)" }}>
                dB SIL
              </div>
              <p className="mt-5 font-mono text-[10px] uppercase tracking-[0.22em] text-white/45">
            ...
            <motion.div variants={fadeUp}>
              ...
              <div className="mt-8 grid grid-cols-3 gap-6">
                {[
                  ...
                  <div key={s.l}>
                    <div className="font-serif text-[32px] leading-none text-white">{s.n}</div>
      ...
      {/* ═══ PLATFORMS ═══ */}
      <section className="border-y border-black/[0.06] bg-[#f4f3f0] py-8">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
            ...
            <motion.div variants={stagger}>
              {caseStudies.map((s) => (
                <motion.div
                  key={s.id}
                  variants={fadeUp}
                  className="border-t border-black/[0.07] py-8"
                >
                  <div className="mb-3 flex items-center justify-between gap-4">
                    <span className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#888888]">{s.aircraft} · {s.category}</span>
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-baseline sm:gap-8">
                    <span className="shrink-0 font-serif leading-none text-[#111111]" style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}>
                      {s.result}
                    </span>
          ...
          <Reveal className="grid gap-14 lg:grid-cols-2 lg:gap-20">
            ...
            <motion.div variants={stagger}>
              {[
                ...
                <motion.div key={d.n} variants={fadeUp} className="grid grid-cols-[44px_1fr] gap-5 border-t border-black/[0.09] py-7">
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <Reveal className="mx-auto max-w-3xl text-center">
            <motion.div variants={fadeUp}>
              ...
              <p className="mx-auto mt-7 max-w-lg text-[15px] leading-[1.95] text-white/60">
              ...
              <div className="mt-10 flex flex-wrap justify-center gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2.5 rounded-full border border-white/15 px-8 py-4 font-mono text-[11px] uppercase tracking-[0.18em] text-white/65 transition-all hover:border-white/30 hover:text-white"
                >
                  info@luminary.aero
                </a>
              </div>
