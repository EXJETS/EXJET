      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10">
            ...
            <Link
              href="/shop/products"
              className="hidden sm:inline-flex items-center gap-1.5 text-sm font-medium text-indigo-600 hover:text-indigo-800 transition-colors"
            >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((cat) => (
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-sm text-gray-900 group-hover:text-indigo-700 transition-colors">
                    {cat.name}
                  </p>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10">
            ...
            <Link
              href="/shop/products?filter=best-seller"
              className="hidden sm:inline-flex items-center gap-1.5 text-sm font-medium text-indigo-600 hover:text-indigo-800 transition-colors"
            >
      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <Link
              href="/shop/products?filter=sale"
              className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-500 to-orange-500 p-8 text-white group hover:shadow-xl transition-shadow"
            >
              <div className="absolute -right-8 -top-8 h-40 w-40 rounded-full bg-white/10" />
              <div className="absolute -right-4 -bottom-12 h-60 w-60 rounded-full bg-white/5" />
              <div className="relative">
                <div className="text-xs font-semibold uppercase tracking-widest text-red-200 mb-2">
                  Limited Time
                </div>
            ...
            <Link
              ...
              className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 to-purple-700 p-8 text-white group hover:shadow-xl transition-shadow"
            >
              <div className="absolute -right-8 -top-8 h-40 w-40 rounded-full bg-white/10" />
              <div className="absolute -right-4 -bottom-12 h-60 w-60 rounded-full bg-white/5" />
              <div className="relative">
                <div className="text-xs font-semibold uppercase tracking-widest text-indigo-200 mb-2">
                  Just Dropped
                </div>
      ...
      <section className="py-16 bg-indigo-950">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-indigo-300 mb-12 max-w-xl mx-auto">
            We work directly with vetted global suppliers to bring you the best products at the lowest prices — with zero compromise on quality.
          </p>
            ...
            {[
              {
                ...
                desc: "Partnered with top-rated suppliers in 30+ countries for the best selection.",
              },
              {
                icon: "⚡",
                title: "Fast Fulfillment",
                desc: "Orders processed within 24 hours. Track every shipment in real time.",
              },
              {
                icon: "💰",
                title: "Best Price Guarantee",
                desc: "Found it cheaper? We'll match any price. No questions asked.",
              },
            ].map(({ icon, title, desc }) => (
              <div
                key={title}
