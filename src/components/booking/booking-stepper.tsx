              ...
              <div className="flex flex-col items-center">
                <div
                  className={cn(
                    ...
                    complete && "bg-[#0d1f3c] text-white",
                    active && "border border-[#0d1f3c] bg-white text-[#0d1f3c] ring-4 ring-[rgba(13,31,60,0.12)]",
                ...
                <span
                  className={cn(
                    ...
                    step.number <= currentStep ? "text-[#0a1628]" : "text-neutral-400"
                  )}
                >
                  {step.label}
                </span>
                ...
                <div className="mx-3 mt-[-1.5rem] flex-1">
                  <div
                    className={cn(
                      ...
                      step.number < currentStep ? "bg-[#0d1f3c]" : "bg-neutral-200"
                    )}
                  />
                </div>
              )}
