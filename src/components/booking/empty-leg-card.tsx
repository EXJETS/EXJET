...
export function EmptyLegCard({ leg }: { leg: EmptyLeg }) {
  ...
  return (
    <Link
      ...
      className={cn(
        "group relative flex flex-col overflow-hidden rounded-2xl border border-white/[0.08]",
        "bg-gradient-to-b from-white/[0.04] to-white/[0.01] p-6 transition-all",
        "hover:border-white/20 hover:bg-white/[0.06]"
      )}
    >
      {/* Discount pill — Vercel accent */}
      <div className="mb-5 flex items-center justify-between">
        <span className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/5 px-2.5 py-1 font-mono text-[11px] text-white/80">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex flex-col">
          ...
          <span className="mt-1 font-mono text-[34px] font-semibold leading-none text-white">
            {leg.from.code}
          </span>
        </div>
        ...
        <div className="relative flex-1 self-center">
          ...
          <PlaneTakeoff
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-4 w-4 text-white/60 transition-transform duration-500 group-hover:translate-x-0 group-hover:text-white"
            strokeWidth={1.75}
          />
        </div>
      ...
      {/* Meta row */}
      <div className="mt-6 grid grid-cols-3 gap-2 border-t border-white/[0.08] pt-5 text-[12px]">
      ...
      <div className="mt-6 flex items-end justify-between">
        <div>
          <span className="font-mono text-[11px] uppercase tracking-widest text-white/40 line-through">
        ...
        <span className="inline-flex items-center gap-1 rounded-full border border-white/15 bg-white/5 px-3 py-1.5 text-[12px] font-medium text-white transition-colors group-hover:bg-white group-hover:text-black">
          Reserve
