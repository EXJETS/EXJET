...
export function ProductCard({ product, className }: ProductCardProps) {
  ...
  return (
    ...
    >
      {/* Image */}
      <Link href={`/shop/products/${product.slug}`} className="relative block overflow-hidden bg-gray-50 aspect-square">
        <Image
          src={product.image}
          alt={product.name}
          fill
      ...
      <div className="flex flex-col flex-1 p-4 gap-2">
        ...
        <Link href={`/shop/products/${product.slug}`} className="hover:text-indigo-700 transition-colors">
