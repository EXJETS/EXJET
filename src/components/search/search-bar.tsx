  ...
  return (
    ...
    >
      {filtered.slice(0, 8).map((airport) => (
        ...
        >
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-[var(--color-hairline)] bg-[var(--color-ivory)] text-[var(--color-ink-soft)]">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className={cn(
                    "flex h-8 w-8 items-center justify-center rounded-full border border-[var(--color-hairline-strong)] text-[var(--color-ink)] transition-colors",
                    it.value <= it.min
      ...
      <div className="rounded-2xl border border-[var(--color-hairline)] bg-white p-2 backdrop-blur-xl">
        {tripType !== "multi_leg" ? (
          <div className="flex flex-col gap-0 md:flex-row md:items-stretch">
            ...
            <button
              type="submit"
              className="group ml-auto mt-2 flex shrink-0 items-center justify-center gap-1.5 rounded-full bg-[var(--color-ink)] px-6 py-3 text-[13px] font-medium text-white transition-colors hover:bg-[var(--color-ink-soft)] active:scale-[0.98] md:ml-2 md:mt-0"
            >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col items-stretch gap-2 px-1 pt-1 sm:flex-row sm:items-center sm:justify-between">
              <button
                type="button"
                onClick={addLeg}
                className="inline-flex items-center justify-center gap-1.5 self-start rounded-full border border-[var(--color-hairline-strong)] bg-[var(--color-ivory)] px-3.5 py-2 text-[12px] font-medium text-[var(--color-ink)] transition-colors hover:bg-[var(--color-bone)]"
              >
                <Plus className="h-3.5 w-3.5" strokeWidth={2} />
                Add another leg
              </button>
              ...
              <div className="flex flex-wrap items-center gap-2 sm:flex-nowrap">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center justify-center gap-1.5 rounded-full bg-[var(--color-ink)] px-6 py-3 text-[13px] font-medium text-white transition-colors hover:bg-[var(--color-ink-soft)] active:scale-[0.98]"
                >
                  <Search className="h-3.5 w-3.5" strokeWidth={2.25} />
                  Search Jets
                </button>
...
function MultiLegRow({
  ...
  return (
    <div className="flex flex-col items-stretch gap-1 rounded-xl border border-[var(--color-hairline)] bg-[var(--color-ivory)]/50 p-1 md:flex-row md:items-center">
