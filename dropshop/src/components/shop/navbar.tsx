          ...
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {count > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 h-[18px] w-[18px] min-w-[18px] rounded-full bg-indigo-600 text-white text-[10px] font-bold flex items-center justify-center">
                    {count > 99 ? "99+" : count}
                  </span>
                )}
              </button>
